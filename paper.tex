...
algebraically derivable from the others within the set).

\begin{table}[H]
\centering
\small
\caption{Complete lattice address assignments for 43 dimensionless ratios.}
\label{tab:full_addresses}
\begin{tabular}{@{}llrrrl@{}}
\toprule
Sector & Ratio & Value & $(C, m)$ & $C/\vp^m$ & Rel.~err \\
\midrule
\multicolumn{6}{@{}l}{\textit{Gauge couplings}} \\
gauge & $1/\alpha$ & 137.036 & $(360, 2)$ & 137.508 & $+0.34\%$ \\
...
\addlinespace
\multicolumn{6}{@{}l}{\textit{Lepton mass ratios}} \\
lepton & $m_\tau/m_e$ & 3477.2 & $(120, -7)$ & 3484.1 & $+0.20\%$ \\
lepton & $m_p/m_e$ & 1836.2 & $(15, -10)$ & 1844.9 & $+0.48\%$ \\
lepton & $m_\tau/m_\mu$ & 16.82 & $(45, 2)$ & 17.19 & $+2.21\%$ \\
\addlinespace
\multicolumn{6}{@{}l}{\textit{Quark mass ratios}} \\
quark & $m_t/m_\tau$ & 97.23 & $(60, -1)$ & 97.08 & $-0.15\%$ \\
quark & $m_b/m_\tau$ & 2.352 & $(180, 9)$ & 2.368 & $+0.66\%$ \\
quark & $m_H/m_W$ & 1.558 & $(45, 7)$ & 1.550 & $-0.54\%$ \\
quark & $m_t/m_W$ & 2.149 & $(15, 4)$ & 2.188 & $+1.82\%$ \\
quark & $m_Z/\Lambda_{\mathrm{QCD}}$ & 291.69 & $(180, -1)$ & 291.25 & $-0.15\%$ \\
\addlinespace
\multicolumn{6}{@{}l}{\textit{Energy hierarchy}} \\
hierarchy & $\MPl/\mZ$ & $1.34\times 10^{17}$ & $(120, -82)$ & --- & $\sim\!0\%$ \\
hierarchy & $\QGUT/\mZ$ & $3.5\times 10^{14}$ & $(360, -70)$ & --- & $\sim\!0\%$ \\
hierarchy & $\MPl/\QGUT$ & $3.8\times 10^{2}$ & $(180, -1)$ & --- & $\sim\!0\%$ \\
\addlinespace
\multicolumn{6}{@{}l}{\textit{CKM mixing}} \\
CKM & $|V_{ud}|$ & 0.9737 & $(120, 10)$ & 0.9754 & $+0.20\%$ \\
CKM & $|V_{us}|$ & 0.2243 & $(45, 11)$ & 0.2261 & $+0.81\%$ \\
CKM & $|V_{td}|$ & 0.0080 & $(120, 20)$ & 0.0080 & $-0.84\%$ \\
CKM & $\delta_{\mathrm{CKM}}/\pi$ & 0.364 & $(45, 10)$ & 0.365 & $+0.48\%$ \\
\addlinespace
\multicolumn{6}{@{}l}{\textit{PMNS mixing}} \\
PMNS & $\sin^2\theta_{12}$ & 0.304 & $(60, 11)$ & 0.302 & $-0.82\%$ \\
PMNS & $\sin^2\theta_{23}$ & 0.573 & $(180, 12)$ & 0.559 & $-2.44\%$ \\
PMNS & $\sin^2\theta_{13}$ & 0.02219 & $(120, 18)$ & 0.02077 & $-6.40\%$ \\
\addlinespace
\multicolumn{6}{@{}l}{\textit{Anomalous magnetic moments}} \\
anomalous & $a_e = (g{-}2)_e/2$ & 0.001160 & $(120, 24)$ & 0.001157 & $-0.20\%$ \\
anomalous & $\alpha/(2\pi)$ & 0.001161 & $(120, 24)$ & 0.001157 & $-0.35\%$ \\
\addlinespace
\multicolumn{6}{@{}l}{\textit{Baryon/meson}} \\
baryon & $(m_n - m_p)/m_e$ & 2.530 & $(45, 6)$ & 2.508 & $-0.89\%$ \\
\bottomrule
\end{tabular}
\end{table}

Note: this table shows a representative selection.  The complete 43-ratio
